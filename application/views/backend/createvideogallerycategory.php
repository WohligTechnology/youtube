 <div class="row">
<div class="col s12">
<h4 class="pad-left-15">Create Video Gallery Category</h4>
</div>
<form class='col s12' method='post' action='<?php echo site_url("site/createvideogallerycategorysubmit");?>' enctype= 'multipart/form-data'>
<div class=" row">
